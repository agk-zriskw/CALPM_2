...
Porównanie wyników pomiarowych stężeń PM_10\_ wykonanych przy zastowaniu dwóch podobnych metod pomiarowych:
...
ops <- 
  ...
  mutate(
    ...
    day_work = case_when(
      wday %in% c("Mon", "Tue", "Wed", "Thu", "Fri") ~ "week",
...
Dane zostały podzielone na odpowiednie grupy w celu wukonanie modeli uczenia maszynowego. Jako zbiór weryfikacyjny `weryfikacja`.
